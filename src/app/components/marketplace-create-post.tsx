...
import { X, Bold, Italic, Underline, List, ListOrdered, Smile, Image, Video, FileText, BarChart3, DollarSign, Loader2 } from 'lucide-react';
...
export function MarketplaceCreatePost({ isOpen, onClose, onPost, userPhoto, userName }: MarketplaceCreatePostProps) {
  ...
  const handleImageSelect = () => {
    ...
    const imageUrl = 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=600';
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <div className="text-sm text-gray-500">Post to: Local Marketplace</div>
            </div>
          </div>
          ...
          <textarea
            ...
            placeholder="List a service, offer a gig, or post a local job..."
          ...
          {/* Media Attachments - Market specific */}
          <div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-200">
            ...
            <button className="flex flex-col items-center gap-1 text-gray-600 hover:text-purple-600 transition-colors group" disabled={isPosting}>
              ...
              <span className="text-xs">Add Price</span>
            </button>
            <button className="flex flex-col items-center gap-1 text-gray-600 hover:text-purple-600 transition-colors group" disabled={isPosting}>
              <div className="p-2 group-hover:bg-purple-50 rounded-lg transition-colors">
